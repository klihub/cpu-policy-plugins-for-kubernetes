...
import (
	...
	cpupoolsintelcomv1draft1 "github.com/klihub/cpu-policy-plugins-for-kubernetes/pkg/apis/cpupools.intel.com/v1draft1"
	versioned "github.com/klihub/cpu-policy-plugins-for-kubernetes/pkg/client/clientset/versioned"
	...
	v1draft1 "github.com/klihub/cpu-policy-plugins-for-kubernetes/pkg/client/listers/cpupools.intel.com/v1draft1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CpupoolsV1draft1().Metrics(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CpupoolsV1draft1().Metrics(namespace).Watch(options)
			},
		},
		&cpupoolsintelcomv1draft1.Metric{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *metricInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cpupoolsintelcomv1draft1.Metric{}, f.defaultInformer)
}

func (f *metricInformer) Lister() v1draft1.MetricLister {
	return v1draft1.NewMetricLister(f.Informer().GetIndexer())
}
